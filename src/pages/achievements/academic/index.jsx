...
import { fetchAchievements, setKeyword, setPage, setActivityType, setAchievementType, setCompetitionLevel } from '../../../redux/achievements/actions'
import { activityTypeOptions, achievementTypeOptions, competitionLevelOptions } from '../../../constants'
...
const AcademicAchievementsPage = () => {
  ...
  useEffect(() => {
    dispatch(fetchAchievements(undefined, 'Akademik'))
  }, [
    dispatch,
  ...
  return (
    <>
      <Breadcrumb secondLevelText="Prestasi Akademik" />
      <h1 className="fs-3">Prestasi Akademik</h1>
      <div className="mb-3">
